                ...
                <div class="panel-body">
                    <div class="formcontainer ">
                        ...
                        <form:form commandName="paymentforticketp" action="addpayment"
                            ...
                            <div class="form-group">
                                <form:hidden  class="form-control" value="{{selectedSup3.fareid}}" path="fareid"></form:hidden>
                                </div>
                                
                              <div class="form-group">
                                        <form:input class="form-control" value="{{selectedSup3.fareamt}}" path="fareamt"></form:input>
                                        </div>
                            ...
                            <c:if test="${!check}">
                                <form:button id="editbuttons" type="submit" name="EditPay" class="btn">Edit
                                    Details</form:button>
                                <form:button id="removebuttons" type="reset" class="btn">Reset
                                    Details</form:button>
                            </c:if>
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <tr ng-repeat="bsc in paymentlist | filter:test">
                                        ...
                                        <td><a href="editpaymentbutton?getcid={{bsc.paymentid}}"><button id="editbuttons" type="submit" class="btn btn-warning">Edit</button></a> 
                                            <a href="removepayment/{{bsc.paymentid}}"><button id="removebuttons" type="button" class="btn btn-danger">Remove</button></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
