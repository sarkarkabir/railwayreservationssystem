                ...
                <div class="panel-body">
                    <div class="formcontainer ">
                        ...
                        <form:form commandName="newfarechartObject" action="farechartvaluadd"
                            ...
                            <div class="form-group">
                                <select class="form-control" ng-model="fromstationid" ng-options=" x.stationname as  x.stationname  for x in stationservlist">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <select class="form-control" ng-model="tostationid" ng-options="x.stationname as x.stationname  for x in stationservlist" >
                                        <option value="">-- choose an option --</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                {{comname}}
                                <div class="form-group">
                                    <select class="form-control" ng-model="comname" ng-options="x.comname as x.comname for x in comtypelist" >
                                        <option value="">-- choose an option --</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <select class="form-control" ng-model="passtypeid" ng-options="x.passtype as x.passtype for x in passengertypelist" >
                                        <option value="">-- choose an option --</option>
                                    </select>
                                </div>
                                <div class="form-group">
                        ...
                        <li class="list-group-item" height="45px"
                            ...
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td><a href="editingfarechart?getfid={{product.fareid}}"><button id="editbuttons"
                                                                                                     type="submit" class="btn">Edit</button></a> <a
                                            href="removingfarechart/{{product.fareid}}"><button id="removebuttons"
