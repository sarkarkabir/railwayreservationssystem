...
<!--js-->
<script src="resources/deshboardplug/js/jquery-2.1.1.min.js"></script> 
<!--icons-css-->
<link href="resources/deshboardplug/css/font-awesome.css" rel="stylesheet"> 
<!--Google Fonts-->
<link href='resources/deshboardplug/fonts.googleapis.com/css?family=Carrois+Gothic' rel='stylesheet' type='text/css'>
<link href='resources/deshboardplug/fonts.googleapis.com/css?family=Work+Sans:400,500,600' rel='stylesheet' type='text/css'>
<!--static chart-->
<script src="resources/deshboardplug/js/Chart.min.js"></script>
<!--//charts-->
<!-- geo chart -->
    ...
    <!--<script src="lib/html5shiv/html5shiv.js"></script>-->
     <!-- Chartinator  -->
    <script src="resources/deshboardplug/js/chartinator.js" ></script>
...
<!--skycons-icons-->
<script src="resources/deshboardplug/js/skycons.js"></script>
<!--//skycons-icons-->
</head>
<body>	
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left">
							<div class="logo-name">
									 <a href="index.html"> <h1>Railway</h1> 
    ...
    <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        ...
		        <li><a href="#"><i class="fa fa-cogs"></i><span>AllTraininfo</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul>
		            <li><a href="stationpage">Add Station</a></li>
		            <li><a href="traininformationpage">Add Train</a></li>
		            <li><a href="showtrainpage">AddTrain Seat</a></li>
                            
                             <li><a href="showingcategorypage">Add Category</a></li>
                             <li><a href="compartpage">Compartment type</a></li>
                             <li><a href="showcomsubtypepage">Compartmentsubtype</a></li>
                             <li><a href="farechartpage">fareChart</a></li>
                             
                             <li><a href="passengerpage">Passengerinfo</a></li>
                             <li><a href="typepassengerpage">passengertype</a></li>
                             
		            <li><a href="availabletrainpage">search Train</a></li>		            
		           
		            <li><a href="reservationdetailspage">reservationdetails</a></li>
                             <li><a href="showcartpage">paymentby cart</a></li>
                            
		          </ul>
		        </li>
		        <li id="menu-comunicacao" ><a href="#"><i class="fa fa-book nav_icon"></i><span>Report</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul id="menu-comunicacao-sub" >
		            <li id="menu-mensagens" style="width: 120px" ><a href="reportreservation">reservation</a>		              
		            </li>
                            
		            <li id="menu-arquivos" ><a href="ReservebyptnNumber">ReservebyptnNumber</a></li>
		            <li id="menu-arquivos" ><a href="reportoneView">compartmentreport</a></li>
		            <li id="menu-arquivos" ><a href="reservationfareamt">Farereport</a></li>
		            <li id="menu-arquivos" ><a href="paymetfareamt">paymentReport</a></li>
...
<!--scrolling js-->
		<script src="resources/deshboardplug/js/jquery.nicescroll.js"></script>
		<script src="resources/deshboardplug/js/scripts.js"></script>
		<!--//scrolling js-->
<script src="resources/deshboardplug/js/bootstrap.js"> </script>
