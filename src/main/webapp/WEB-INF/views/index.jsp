...
<link rel="stylesheet" type="text/css" href="resources/forntpage/styles/bootstrap4/bootstrap.min.css">
<link href="resources/forntpage/plugins/font-awesome-4.7.0/css/font-awesome.min.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="resources/forntpage/plugins/OwlCarousel2-2.2.1/owl.carousel.css">
<link rel="stylesheet" type="text/css" href="resources/forntpage/plugins/OwlCarousel2-2.2.1/owl.theme.default.css">
<link rel="stylesheet" type="text/css" href="resources/forntpage/plugins/OwlCarousel2-2.2.1/animate.css">
<link rel="stylesheet" type="text/css" href="resources/forntpage/styles/main_styles.css">
<link rel="stylesheet" type="text/css" href="resources/forntpage/styles/responsive.css">
</head>
...
<div class="super_container">
				...
				<div class="row">
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						<div class="logo_container">
							<div class="logo"><a href="#"><img src="images/logo.png" alt="">Railway</a></div>
						</div>
						<div class="main_nav_container ml-auto">
							<ul class="main_nav_list">
								<li class="main_nav_item"><a href="#">home</a></li>
								<li class="main_nav_item"><a href="about.html">about us</a></li>
								<li class="main_nav_item"><a href="passengerpage">add passengerinfo</a></li>
								<li class="main_nav_item"><a href="typepassengerpage">passengertype</a></li>
                                                                 <li class="main_nav_item"><a href="farechartpageforuser">fareChart</a></li>
								<li class="main_nav_item"><a href="availabletrainpage">searchtrain And Buyticket</a></li>
								<li class="main_nav_item"><a href="blogpost">Blog</a></li>
								<li class="main_nav_item"><a href="showcartpage">paymentby cart</a></li>
							</ul>
						</div>
	...
	<div class="menu trans_500">
		<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
			...
			<div class="logo menu_logo"><a href="#"><img src="resources/forntpage/images/logo.png" alt=""></a></div>
			<ul>
		...
		<div class="home_slider_container">
			...
			<div class="owl-carousel owl-theme home_slider">
				...
				<div class="owl-item home_slider_item">
					...
					<div class="home_slider_background" style="background-image:url(resources/forntpage/images/home_slider.jpg)"></div>

					<div class="home_slider_content text-center">
						<div class="home_slider_content_inner" data-animation-in="flipInX" data-animation-out="animate-out fadeOut">
							<h1>Enjoy the Railway</h1>
							<h1> Travle In our Country</h1>
								...
								<div class="offers_content">
									...
									<div class="offers_icons">
										<ul class="offers_icons_list">
											<li class="offers_icons_item"><img src="resources/forntpage/images/post.png" alt=""></li>
											<li class="offers_icons_item"><img src="resources/forntpage/images/compass.png" alt=""></li>
											<li class="offers_icons_item"><img src="resources/forntpage/images/bicycle.png" alt=""></li>
											<li class="offers_icons_item"><img src="resources/forntpage/images/sailboat.png" alt=""></li>
										</ul>
									</div>
					...
					<div class="footer_col">
						<div class="footer_content footer_about">
							<div class="logo_container footer_logo">
								<div class="logo"><a href="#"><img src="resources/forntpage/images/logo.png" alt="">Railway</a></div>
							</div>
					...
					<div class="footer_col">
						...
						<div class="footer_content footer_blog">
							...
							<div class="footer_blog_item clearfix">
								<div class="footer_blog_image"><img src="resources/forntpage/images/footer_blog_1.jpg" alt="https://unsplash.com/@avidenov"></div>
							...
							<!-- Footer blog item -->
							<div class="footer_blog_item clearfix">
								<div class="footer_blog_image"><img src="resources/forntpage/images/footer_blog_2.jpg" alt="https://unsplash.com/@deannaritchie"></div>
								<div class="footer_blog_content">
							...
							<!-- Footer blog item -->
							<div class="footer_blog_item clearfix">
								<div class="footer_blog_image"><img src="resources/forntpage/images/footer_blog_3.jpg" alt="https://unsplash.com/@bergeryap87"></div>
								<div class="footer_blog_content">
									<div class="footer_blog_title"><a href="blog.html">Travel with us this year</a></div>
									<div class="footer_blog_date">Nov 29, 2017</div>
								</div>
						...
						<div class="footer_content footer_contact">
							<ul class="contact_info_list">
								<li class="contact_info_item d-flex flex-row">
									<div><div class="contact_info_icon"><img src="resources/forntpage/images/placeholder.svg" alt=""></div></div>
									<div class="contact_info_text">4127 Raoul Wallenber 45b-c Gibraltar</div>
								</li>
								<li class="contact_info_item d-flex flex-row">
									<div><div class="contact_info_icon"><img src="resources/forntpage/images/phone-call.svg" alt=""></div></div>
									<div class="contact_info_text">2556-808-8613</div>
								</li>
								<li class="contact_info_item d-flex flex-row">
									<div><div class="contact_info_icon"><img src="resources/forntpage/images/message.svg" alt=""></div></div>
									<div class="contact_info_text"><a href="mailto:contactme@gmail.com?Subject=Hello" target="_top">contactme@gmail.com</a></div>
								</li>
								<li class="contact_info_item d-flex flex-row">
									<div><div class="contact_info_icon"><img src="resources/forntpage/images/planet-earth.svg" alt=""></div></div>
...
<script src="resources/forntpage/js/jquery-3.2.1.min.js"></script>
<script src="resources/forntpage/styles/bootstrap4/popper.js"></script>
<script src="resources/forntpage/styles/bootstrap4/bootstrap.min.js"></script>
<script src="resources/forntpage/plugins/OwlCarousel2-2.2.1/owl.carousel.js"></script>
<script src="resources/forntpage/plugins/easing/easing.js"></script>
<script src="resources/forntpage/js/custom.js"></script>
