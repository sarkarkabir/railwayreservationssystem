                            ...
                            <form:form name="addStationObject"
                                ...
                                <div class="form-group">
                                    <form:input class="form-control"
                                                Placeholder="Department Id" type="text" path="stationid" required="true"></form:input>
                                    </div>
                                    <div class="form-group">
                                    <form:input class="form-control"
                                                Placeholder="Department Name" type="text" path="stationname" required="true"></form:input>
                                    </div>
                                    
                                <form:button class="btn btn-success" id="editbuttons" type="submit" name="Addaddstation"
                            ...
                            <form:form name="addStationObject"
                                ...
                                <div class="form-group">
                                    <form:input id="name" class="form-control"
                                                Placeholder="Category Id" type="text" path="stationid" readonly="true"></form:input>
                                    </div>
                                    <div class="form-group">
                                    <form:input id="name" class="form-control"
                                                Placeholder="Category Name" type="text" path="stationname"></form:input>
                                    </div>
...
<div class="chit-chat-layer1">
	<div class="card-body" >
                                <div class="table-responsive"  ng-app="myapp1"
                     ng-controller="CategoryController1" width="100%">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <tr ng-repeat="Sv in Station">
                                               
                                                <td>{{Sv.deptid}}</td>
                                                <td>{{Sv.deptname}}</td>
                                                <td><a href="editaddstationbutton?getcid={{Sv.stationid}}"><button id="editbuttons" type="submit" class="btn btn-warning">Edit</button></a> 
                                                    <a href="removeaddstation/{{Sv.stationid}}"><button id="removebuttons" type="button" class="btn btn-danger">Remove</button></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
